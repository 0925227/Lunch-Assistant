...
namespace NeuralNetwork.Helpers
{
	...
	{
		public static void ExportNetwork(Network network, string user)
		{
			var dn = GetHelperNetwork(network);

            //System.IO.File.CreateText(@"wwwroot\data\WriteLines.txt");

            using (var file = System.IO.File.CreateText($@"wwwroot\data\{user}.txt"))
            {
